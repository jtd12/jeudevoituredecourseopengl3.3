...
decor::decor(const char* c,
	const char* map,const char *tex)
{
	obj=new objloader();
	name=c;
...
void decor::draw(glm::mat4 ProjectionMatrix,glm::mat4 ViewMatrix,glm::mat4 ModelMatrix)
{
	...
	std::vector<glm::vec3>& decor::getSpawnPoints()
	{
		return spawnpoints;
	}
