...
allCars[1]->carAI.push_back(new vehiculeAI("voitureAI",glm::vec3(2550,200,1200),0.02,0.0,"data/vehicule/vehicule0.obj","data/vehicule/Car_1_Diffuse_White.bmp"));
allCars[2]->carAI.push_back(new vehiculeAI("voitureAI2",glm::vec3(2550,200,1200),0.02,0.0,"data/vehicule/vehicule1.obj","data/vehicule/Car_2_Diffuse_White.bmp"));
allCars[3]->carAI.push_back(new vehiculeAI("voitureAI3",glm::vec3(2500,200,1200),0.02,0.0,"data/vehicule/vehicule2.obj","data/vehicule/Car_3_Diffuse_White.bmp"));
allCars[4]->carAI.push_back(new vehiculeAI("voitureAI4",glm::vec3(2550,200,1200),0.02,0.0,"data/vehicule/vehicule3.obj","data/vehicule/Car_4_Diffuse_White.bmp"));
allCars[5]->carAI.push_back(new vehiculeAI("voitureAI5",glm::vec3(2200,200,1200),0.02,0.0,"data/vehicule/vehicule4.obj","data/vehicule/Car_6_Diffuse_White.bmp"));
allCars[6]->carAI.push_back(new vehiculeAI("voitureAI6",glm::vec3(2500,200,1200),0.02,0.0,"data/vehicule/vehicule5.obj","data/vehicule/Car_7_Diffuse_White.bmp"));
allCars[7]->carAI.push_back(new vehiculeAI("voitureAI6",glm::vec3(2250,200,1200),0.02,0.0,"data/vehicule/vehicule5.obj","data/vehicule/Car_7_Diffuse_White.bmp"));
allCars[8]->carAI.push_back(new vehiculeAI("voitureAI6",glm::vec3(2400,200,1200),0.02,0.0,"data/vehicule/vehicule4.obj","data/vehicule/Car_6_Diffuse_White.bmp"));
...
void setup::draw()
{
	...
	allCars[0]->car->draw(cam->getProjectionMatrix(),cam->getViewMatrix(),glm::mat4(1.0));

	for(int w=1;w<allCars.size();w++)
	 for(int i=0;i<allCars[w]->carAI.size();i++)
	  allCars[w]->carAI[0]->draw(cam->getProjectionMatrix(),cam->getViewMatrix(),glm::mat4(1.0));
